...
class mystery1(SCSA):
    """ SCSA that generates codes from mystery1 txt file
    """
    ...
    def __init__(self):
        ...
        self.name = "mystery1"
        file1 = open(
            "../updatedmysterycodefiles/200_codes_for_mystery1_7_5.txt", "r")
        self.codes = file1.readlines()

    def generate_codes(self, length, colors, num_codes=1):
        code = self.codes[0].strip()
        self.codes.remove(self.codes[0])
...
class mystery2(SCSA):
    """ SCSA that generates codes from mystery2 txt file
    """
    ...
    def __init__(self):
        ...
        self.name = "mystery1"
        file1 = open(
            "../updatedmysterycodefiles/200_codes_for_mystery2_7_5.txt", "r")
        self.codes = file1.readlines()
...
class mystery3(SCSA):
    """ SCSA that generates codes from mystery3 txt file
    """
    ...
    def __init__(self):
        ...
        self.name = "mystery1"
        file1 = open(
            "../updatedmysterycodefiles/200_codes_for_mystery3_7_5.txt", "r")
        self.codes = file1.readlines()
...
class mystery4(SCSA):
    """ SCSA that generates codes from mystery4 txt file
    """
    ...
    def __init__(self):
        ...
        self.name = "mystery1"
        file1 = open(
            "../updatedmysterycodefiles/200_codes_for_mystery4_7_5.txt", "r")
        self.codes = file1.readlines()
...
class mystery5(SCSA):
    """ SCSA that generates codes from mystery5 txt file
    """
    ...
    def __init__(self):
        ...
        self.name = "mystery1"
        file1 = open(
            "../updatedmysterycodefiles/200_codes_for_mystery5_7_5.txt", "r")
        self.codes = file1.readlines()
